package com.vicheak.app.category.service.config;
...
@Builder
@Slf4j
@EnableMongoRepositories(basePackages = "com.vicheak.app.category.service.repository")
public class MongoConfig extends AbstractMongoClientConfiguration {
    ...
    public Collection getMappingBasePackages() {
        return Collections.singleton("com.vicheak.category.service");
    }
